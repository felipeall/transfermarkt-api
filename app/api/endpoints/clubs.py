...
from app.schemas.clubs import ClubPlayers, ClubProfile, ClubSearch
...
@router.get("/search/{club_name}", response_model=ClubSearch, response_model_exclude_none=True)
...
@router.get("/{club_id}/profile", response_model=ClubProfile, response_model_exclude_none=True)
...
@router.get("/{club_id}/players", response_model=ClubPlayers, response_model_exclude_none=True)
