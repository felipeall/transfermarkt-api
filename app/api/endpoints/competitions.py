...
from app.schemas.competitions import CompetitionClubs, CompetitionSearch
...
@router.get("/search/{competition_name}", response_model=CompetitionSearch)
...
@router.get("/{competition_id}/clubs", response_model=CompetitionClubs)
